                    ...
                    <div class="card mb-4">
                        ...
                        <form action="{{ route('salaries_exoneration.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="periode_en_jours" id="periode_en_jours" class="form-control" onkeypress="return event.charCode >= 48 && event.charCode <= 57 || event.charCode === 44">
                                    </div>

                                    <!-- Champ pour les traitements bruts -->
                                    <div class="form-group">
                                        <label for="brut_traitements">Traitements Bruts</label>
                                        <input type="text" name="brut_traitements" id="brut_traitements" class="form-control" onkeypress="return event.charCode >= 48 && event.charCode <= 57 || event.charCode === 44">
                                    </div>

                                    <!-- Champ pour les avantages -->
                                    <div class="form-group">
                                        <label for="avantages">Avantages</label>
                                        <input type="text" name="avantages" id="avantages" class="form-control" onkeypress="return event.charCode >= 48 && event.charCode <= 57 || event.charCode === 44">
                                    </div>

                                    <!-- Champ pour les indemnités -->
                                    <div class="form-group">
                                        <label for="indemnite">Indemnités</label>
                                        <input type="text" name="indemnite" id="indemnite" class="form-control" onkeypress="return event.charCode >= 48 && event.charCode <= 57 || event.charCode === 44">
                                    </div>

                                    <!-- Champ pour le revenu brut imposable -->
                                    <div class="form-group">
                                        <label for="revenu_brut_imposable">Revenu Brut Imposable</label>
                                        <input type="text" name="revenu_brut_imposable" id="revenu_brut_imposable" class="form-control" onkeypress="return event.charCode >= 48 && event.charCode <= 57 || event.charCode === 44">
                                    </div>

                                    <!-- Champ pour les retenues opérées -->
                                    <div class="form-group">
                                        <label for="retenues_operees">Retenues Opérées</label>
                                        <input type="text" name="retenues_operees" id="retenues_operees" class="form-control" onkeypress="return event.charCode >= 48 && event.charCode <= 57 || event.charCode === 44">
                                    </div>

                                    <!-- Champ pour le revenu net imposable -->
                                    <div class="form-group">
                                        <label for="revenu_net_imposable">Revenu Net Imposable</label>
                                        <input type="text" name="revenu_net_imposable" id="revenu_net_imposable" class="form-control" onkeypress="return event.charCode >= 48 && event.charCode <= 57 || event.charCode === 44">
                                    </div>
