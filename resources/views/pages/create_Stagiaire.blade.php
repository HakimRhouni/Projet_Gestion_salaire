                            ...
                            <div class="card-body">
                                <form action="{{ route('stagiaires.store', ['id_periode' => $id_periode, 'id_societe' => $id_societe]) }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="indemnite" name="indemnite" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="retenues" class="form-label">Retenues</label>
                                        <input type="number" class="form-control" id="retenues" name="retenues" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="net_imposable" class="form-label">Net Imposable</label>
                                        <input type="number" class="form-control" id="net_imposable" name="net_imposable" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="net_imposable" class="form-label">Periode</label>
                                        <input type="number" class="form-control" id="periode" name="periode" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required>
                                    </div>
