                    ...
                    <div class="col-12">
                        <div class="card mb-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="penalite" type="text" class="form-control @error('penalite') is-invalid @enderror" name="penalite" value="{{ old('penalite') }}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="majorations" type="text" class="form-control @error('majorations') is-invalid @enderror" name="majorations" value="{{ old('majorations') }}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="total_verse" type="text" class="form-control @error('total_verse') is-invalid @enderror" name="total_verse" value="{{ old('total_verse') }}" required>
