                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('beneficiairesOS.update', ['id_periode' => $id_periode, 'id_societe' => $beneficiaire->id]) }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="nbr_actions_acquises" type="text" class="form-control" name="nbr_actions_acquises" value="{{ $beneficiaire->nbr_actions_acquises }}" onkeypress="return event.charCode >= 48 && event.charCode <= 57  || event.charCode === 44" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="nbr_actions_distribuees" type="text" class="form-control" name="nbr_actions_distribuees" value="{{ $beneficiaire->nbr_actions_distribuees }}" onkeypress="return event.charCode >= 48 && event.charCode <= 57  || event.charCode === 44" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="prix_acquisition" type="text" class="form-control" name="prix_acquisition" value="{{ $beneficiaire->prix_acquisition }}" onkeypress="return event.charCode >= 48 && event.charCode <= 57  || event.charCode === 44" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="valeur_action_attribution" type="text" class="form-control" name="valeur_action_attribution" value="{{ $beneficiaire->valeur_action_attribution }}" onkeypress="return event.charCode >= 48 && event.charCode <= 57  || event.charCode === 44" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="valeur_action_levee" type="text" class="form-control" name="valeur_action_levee" value="{{ $beneficiaire->valeur_action_levee }} " onkeypress="return event.charCode >= 48 && event.charCode <= 57  || event.charCode === 44">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="nbr_actions_cedees" type="text" class="form-control" name="nbr_actions_cedees" value="{{ $beneficiaire->nbr_actions_cedees }}" onkeypress="return event.charCode >= 48 && event.charCode <= 57  || event.charCode === 44">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="montant_abondement" type="text" class="form-control" name="montant_abondement" value="{{ $beneficiaire->montant_abondement }}" onkeypress="return event.charCode >= 48 && event.charCode <= 57  || event.charCode === 44">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="complement_salaire" type="text" class="form-control" name="complement_salaire" value="{{ $beneficiaire->complement_salaire }}" onkeypress="return event.charCode >= 48 && event.charCode <= 57  || event.charCode === 44">
                                        </div>
                                    </div>
